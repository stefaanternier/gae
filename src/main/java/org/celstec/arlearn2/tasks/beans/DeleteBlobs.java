...
//		for (Iterator<FilePathEntity> iterator = FilePathManager.getFilePathJDOs(getFullAccount(), getRunId(), null, null).iterator(); iterator.hasNext();) {               //TODO check if this deletion works and iff fullAccount is not an email but 1:123
//			FilePathEntity fpjdo = (FilePathEntity) iterator.next();
//			try {
