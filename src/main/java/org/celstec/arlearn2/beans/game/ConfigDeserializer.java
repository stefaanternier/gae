...
public class ConfigDeserializer extends BeanDeserializer{
	...
	public void initBean(JSONObject object, Bean genericBean) throws JSONException {
        ...
        if (object.has("primaryColor")) oq.setPrimaryColor(object.getString("primaryColor"));
		if (object.has("secondaryColor")) oq.setSecondaryColor(object.getString("secondaryColor"));
	}
