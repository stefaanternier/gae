...
//	private List<GeneralItem> manualItems = new ArrayList<GeneralItem>();
	...
	public JSONObject toJSON(Object bean) {
		...
		try {
			...
			if (c.getPrimaryColor()!= null) returnObject.put("primaryColor", c.getPrimaryColor());
			if (c.getSecondaryColor()!= null) returnObject.put("secondaryColor", c.getSecondaryColor());
