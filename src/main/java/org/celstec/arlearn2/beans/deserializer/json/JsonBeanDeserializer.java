...
//				Method m = beanCls.getDeclaredMethod(getBeanMethodName(field.getName()), field.getType());
	...
	static {
        ...
        customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.PureAudio", PureAudio.deserializer);
		...
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.PictureQuestion", PictureQuestion.deserializer);
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.AudioQuestion", AudioQuestion.deserializer);
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.TextQuestion", TextQuestion.deserializer);
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.VideoQuestion", VideoQuestion.deserializer);
		...
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.EndMessage", EndMessage.deserializer);
		...
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.ImageClickQuestionZone", ImageClickQuestionZone.deserializer);
		customDeserializerMapString.put("org.celstec.arlearn2.beans.generalItem.ImageClickQuestion", ImageClickQuestion.deserializer);
