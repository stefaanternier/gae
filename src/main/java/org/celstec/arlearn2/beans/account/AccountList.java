...
public class AccountList extends Bean{
	...
	public void addInvitation(Invitation account) {
		this.invitationList.add(account);
	}
	...
	public static BeanSerializer serializer = new BeanSerializer() {
		...
		public JSONObject toJSON(Object bean) {
			...
			try {
				...
				if (accountList.getInvitationList() != null)
					returnObject.put("invitationList", ListSerializer.toJSON(accountList.getInvitationList()));
	...
	public static BeanDeserializer deserializer = new BeanDeserializer() {
		...
		public void initBean(JSONObject object, Bean genericBean) throws JSONException {
			...
			if (object.has("invitationList"))
				accountList.setAccountList(ListDeserializer.toBean(object.getJSONArray("invitationList"), Invitation.class));
		}
	};
