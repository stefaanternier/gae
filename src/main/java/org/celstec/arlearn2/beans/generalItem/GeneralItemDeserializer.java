...
public class GeneralItemDeserializer extends GameBeanDeserializer {
	...
	public void initBean(JSONObject object, Bean genericBean) throws JSONException {
		...
		if (object.has("label")) gi.setLabel(object.getString("label"));
...
//		if (object.has("showAtTimeStamp")) gi.setShowAtTimeStamp(object.getLong("showAtTimeStamp"));
		...
		if (object.has("primaryColor")) gi.setPrimaryColor(object.getString("primaryColor"));
		if (object.has("secondaryColor")) gi.setSecondaryColor(object.getString("secondaryColor"));
