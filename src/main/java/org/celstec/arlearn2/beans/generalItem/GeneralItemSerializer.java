...
public class GeneralItemSerializer extends GameBeanSerializer{
	...
	public JSONObject toJSON(Object bean) {
		...
		try {
			...
			if (gi.getLabel() != null) returnObject.put("label", gi.getLabel());
			...
			if (gi.getNotification() != null) returnObject.put("notification", JsonBeanSerialiser.serialiseToJson(gi.getNotification()));
...
//			if (gi.getShowAtTimeStamp() != null) returnObject.put("showAtTimeStamp", gi.getShowAtTimeStamp());
			...
			if (gi.getPrimaryColor()!= null) returnObject.put("primaryColor", gi.getPrimaryColor());
			if (gi.getSecondaryColor()!= null) returnObject.put("secondaryColor", gi.getSecondaryColor());
