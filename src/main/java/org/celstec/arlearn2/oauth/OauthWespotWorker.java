...
public class OauthWespotWorker extends OauthWorker {
    ...
    static {
        OauthConfigurationEntity jdo = OauthKeyManager.getConfigurationObject(AccountEntity.WESPOTCLIENT);
...
//            System.out.println("result is "+readUrl);
            ...
            AccountEntity account = AccountManager.addAccount("noFbId", id, AccountEntity.WESPOTCLIENT, email, given_name, family_name, name, picture, false);
