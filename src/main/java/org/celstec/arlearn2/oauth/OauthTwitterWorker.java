...
public class OauthTwitterWorker {
    ...
    static {
        OauthConfigurationEntity jdo = OauthKeyManager.getConfigurationObject(AccountEntity.TWITTERCLIENT);
    ...
    public String afterSuccesfullAuthentication(HttpServletRequest request) {
        ...
        try {
            ...
            AccountEntity account = AccountManager.addAccount("noFbId", ""+user.getId(), AccountEntity.TWITTERCLIENT, "",
                    "", "", user.getName(),
