...
public class Messages extends Service implements Serializable{
    ...
    public String getMessageById(@HeaderParam("Authorization") String token,
                                              ...
                                              @DefaultValue("application/json") @HeaderParam("Accept") String accept)
    {
        ...
        return serialise(md.getMessageById(messageId ), accept);
    }
    ...
    @GET
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    @Path("/runId/{runId}/thread/{threadId}/recentFirst/{amount}")
    public String getRecentMessagesForThread(@HeaderParam("Authorization") String token,
                                                    @PathParam("runId") Long runId,
                                                    @PathParam("threadId") Long threadId,
                                                    @PathParam("amount") Integer amount,
                                                    @DefaultValue("application/json") @HeaderParam("Accept") String accept)
    {
        if (!validCredentials(token))
            return serialise(getInvalidCredentialsBean(), accept);
        MessageDelegator md = new MessageDelegator(this);
        return serialise(md.getRecentMessagesForThread(runId, threadId, amount), accept);
    }
