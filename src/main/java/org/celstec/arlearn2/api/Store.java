...
public class Store extends Service {
    ...
    @GET
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @Path("/categories/lang/{lang}/gameId/{gameId}")
    public String getCategoryByLangGameId(@PathParam("lang") String lang,
                                          @PathParam("gameId") Long gameId,
                                    @DefaultValue("application/json") @HeaderParam("Accept") String accept){
        return serialise(new CategoryDelegator().getCategories(lang, gameId), accept);
    }
